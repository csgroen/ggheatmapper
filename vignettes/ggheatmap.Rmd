...
As of ggheatmap 0.1.2, we've added row facetting options using the `rowv` parameter.
ggheatmap will render parts of the heatmap in different facets if the `rowv`
